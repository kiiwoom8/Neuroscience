...
\question{left=4 of freeRibosome}{polyribosome}{Polyribosome}{?}
\draw[line](freeRibosome) to coordinate(freeRibosomeToPolyribosome) (polyribosome);
\comment{below=0 of freeRibosomeToPolyribosome}{freeRibosomeToPolyribosomeText}{Attached by a thread}{?}
