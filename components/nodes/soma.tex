...
\node[default, draw, right=of nuclearEnvelope](pore){Pores};
...
\comment{right=of chromosome}{chromosomeText}{\textcolor{black}{Number of human's chromosomes:} 46}{\textcolor{black}{Number of human's chromosomes:} ?}
\question{below= of chromosome}{deoxyribonucleicAcid}{Deoxyribonucleic Acid}{?}
\comment{right=of deoxyribonucleicAcid}{dnaTextFirst}{\textcolor{black}{Same in all the cells / size:} 2$\mu$m}{\textcolor{black}{Same in all the cells / size:} ?}
\comment{below right=of deoxyribonucleicAcid, yshift=1cm}{geneExpression}{\textcolor{black}{What DNA reading is known as:} Gene Expression}{\textcolor{black}{What DNA reading is known as:} ?}
...
\comment{below=.3 of rnapToNucleotide, anchor=west}{first}{\textcolor{blue}{1. }Guide the nudleotides into position}{\textcolor{blue}{1. }?}
