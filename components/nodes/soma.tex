% \node[align=center](title) at(page.north, 5){\Huge Soma};

\node[default, draw](soma){Soma};
\question{below left}{1}{soma}{cytoplasm}{Cytoplasm}
...
\question{left}{1}{organelle1}{golgiApparatus}{Golgi Apparatus}
\node[default, draw, above=.3 of golgiApparatus](mitochondria){Mitochondria};
\question{below}{.3}{golgiApparatus}{endoplasmicReticulum}{Endoplasmic Reticulum}
\question{above}{.3}{mitochondria}{ribosome}{Ribosome}
...
\question{below}{1}{chromosome}{deoxyribonucleicAcid}{Deoxyribonucleic Acid}
...
\question{right}{5}{rna}{spliceosome}{Spliceosome}
\question{right}{5}{spliceosome}{mrna}{Messenger Ribonucleic Acid}
% ------------------------------------ Arrows -----------------------------------------------------------
...
\question{below right}{4}{transcription}{rnap}{RNA polymerase}
