\begin{inctext}[label={overlay}, overlay={\node at($(page.north)+(0,-3)$){\Huge Transcription};}]
    \begin{tikzpicture}
        ...
        \comment{left=0 of mrna}{mrnaText}{$1\sim 3$ \textcolor{black}{\% of total RNA samples}}{?}
        ...
        \comment{below=of nucleotideTextSecond}{nucleotideTextThird}{Nucleotide Polymorphism}{\textcolor{black}{What Mutation results from: }?}
        \draw[line](nucleotideTextSecond) to (nucleotideTextThird);
        \comment{below=of nucleotideTextThird}{knockout}{Knockout}{\textcolor{black}{Deleted: }?}
        \comment{below=0 of knockout}{transgenic}{Transgenic}{\textcolor{black}{Overexpressed: }?}
        \comment{below=0 of transgenic}{knockin}{Knockin}{\textcolor{black}{Replaced: }?}

        \draw[line](nucleotideTextThird) to (knockout);
        ...
        *6(-N=-N=(-NH_2)-=)
        ...
        \comment{below=.5 of phosphodiesterBond.west, anchor=west}{clockwise}{Clockwise}{?}
        ...
        \commentAt{$(mrnaFirst.west)+(-.5,0)$}{mrnaLeft}{mRNA}{?}
        \draw[arrow](dnaSecond) to (mrnaFirst);
        \question{below=of mrnaFirst}{trna}{tRNA}{?}
        \comment{left=of trna}{trnaText}{Read Triplet}{?}
        \comment{left=of trnaText}{codon}{Codon}{?}
        \draw[line](trna) to (trnaText);
        \question{right=of trna}{aminoAcid}{Amino Acid}{?}
        \question{right=3 of aminoAcid}{aminoAcidSecond}{Amino Acid}{?}
        \draw[line](aminoAcid) to coordinate(aminoAcidBond) (aminoAcidSecond);
        \comment{above=0 of aminoAcidBond}{peptideBond}{Peptide Bond}{?}
        \comment{below=.5 of trnaText.east, anchor=east}{anticodon}{Contain Anticodon}{?}
        \draw[line](trna) to (aminoAcid);
        \draw[line](trnaText) to (codon);
        \draw[arrow](mrnaFirst) to (trna);
        \question{below=of trna}{peptide}{Peptides}{?}
        \draw[arrow](trna) to (peptide);
        \comment{right=of peptide}{peptideText}{Short chain of amino acids}{?}
        \draw[line](peptide) to (peptideText);

        \question{below left=of peptide, xshift=1.5cm}{oligopeptide}{Oligopeptide}{?}
        \comment{left=of oligopeptide}{oligopeptideText}{Chain of fewer than 20 amino acids}{?}
        \draw[line](oligopeptide) to (oligopeptideText);
        \draw[line](peptide) to (oligopeptide);
        \comment{below=0 of oligopeptide}{dipeptide}{\textcolor{black}{1. }Dipeptide}{\textcolor{black}{1. }?}
        \comment{below=0 of dipeptide}{tripeptide}{\textcolor{black}{2. }Tripeptide}{\textcolor{black}{2. }?}
        \comment{below=0 of tripeptide}{tetrapeptide}{\textcolor{black}{3. }Tetrapeptide}{\textcolor{black}{3. }?}
        \question{below right=of peptide, xshift=-1.5cm}{polypeptide}{Polypeptide}{?}
        \draw[line](peptide) to (polypeptide);
        \question{right=5cm of polypeptide}{proteinSecond}{Protein}{?}
        \draw[arrow](polypeptide) to coordinate(polypeptideToProtein) (proteinSecond);
        \comment{above=0 of polypeptideToProtein}{polypeptideToProteinText}{More than 50 amino acids}{?}
