...
\chemfig{
O=[:-30]P(-[:60]O-[:60])(-[:240]O^{-})-[:-30]O
@{oxygen2}-[:-30]?[a]@{hydrogen2}<[:-60]@{hydrogen3}
(-[:240]O@{oxygen3}-[:240]P(=[:150]O)(-[:240]O^{-})-[:-30]O-[:-30])
-[0,,,,line width=3pt]
>[:60]-[:150,1.18]O?[a]
}};
...
\draw[blue, samples=100, shift=(center5)] plot (\x, {cos(2*deg(\x))});
