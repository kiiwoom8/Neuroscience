...
\comment{above=.5 of mrnaText.east, anchor=east}{mrnaTextFirst}{Coding RNA}{?}
...
\comment{below=of mrnaSecond}{peptide}{Peptide}{?}
\node[below=of peptide]{\href{https://www.youtube.com/watch?v=-L0rikDOX5s}{Adress}};
\draw[arrow](mrnaSecond) to coordinate(mrnaToProtein) (peptide);
\comment{right=0 of mrnaToProtein}{translateText}{Translate}{?}
\comment{below=1.25 of mrnaLeft}{proteinsText}{Protein}{?}
