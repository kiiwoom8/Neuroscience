...
\usepackage{tikz, incgraph, hyperref, ocgx, chemfig, hyperref, indentfirst, soul, graphicx}
\igrset{border=4cm}
\usetikzlibrary{positioning, calc, ocgx, decorations.text, arrows.meta, snakes}
